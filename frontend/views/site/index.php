		...
		<div class="card position-relative">
			<div class="card-body">
				...
				<div id="detailedReports" class="carousel slide detailed-report-carousel position-static pt-2" data-ride="carousel">
					...
					<div style="position: absolute; top: 15px; right:15px; z-index: 1; display: flex; align-items: center; justify-content: center; width: 6%; text-align: center;">
								...
								<div class="col-md-4 grid-margin stretch-card">
									<div class="card">
										<div class="card-body">
											...
											<div class="progress progress-md">
												<div class="progress-bar progress-bar-striped progress-bar-animated bg-warning" style="width: 68%" role="progressbar" aria-valuenow="68" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
											<h4 class="mt-4">Nilai Tukar Petani (NTP)</h4>
											<div class="text-center mt-4">
												<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#DetailModalDua">Lihat Detail</button>
											</div>
										</div>
									</div>
								</div>
			...
			<div class="modal-body">
				...
				<div class="card shadow">
					...
					<a href="#collapseCardDetail01" class="d-block card-header py-3" data-toggle="collapse" role="button"
						...
						<p class="card-title h6 text-white font-weight-normal text-gray-800 mt-2">Program Peningkatan Diversifikasi dan
