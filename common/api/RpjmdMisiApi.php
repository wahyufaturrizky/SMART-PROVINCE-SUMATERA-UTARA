 ...
 * usage : 
 * on controller ->
 * use common\api\RpjmdMisiApi;
 * @author abdil <abdiillah98@gmail.com>
 * 
 * $allData = RpjmdMisiApi::find()->all();
 * $addData = RpjmdMisiApi::add()->data(['columnname' => 'value])->all();
 * $editData = RpjmdMisiApi::edit()->where(['pkcolumn' => 'value])->data(['columnname' => 'value])->save();
 * $deleteData = RpjmdMisiApi::find()->where(['pkcolumn' => 'value])->data(['columnname' => 'value])->delete();
 * 
 * 
 * 
 * 
...
class RpjmdMisiApi extends Model
{
    ...
    public function __construct() {
        ...
        $this->url['all'] = Yii::$app->params['dashboard']['baseUrl']."/api/rpjmd-misi/data";
        $this->url['add'] = Yii::$app->params['dashboard']['baseUrl']."/api/rpjmd-misi/tambah";
        $this->url['edit'] = Yii::$app->params['dashboard']['baseUrl']."/api/rpjmd-misi/ubah";
        $this->url['delete'] = Yii::$app->params['dashboard']['baseUrl']."/api/rpjmd-misi/hapus";
    }
